...
## A more detailed look at the slot of CTSS information
...
Another feature we can determine with _CAGEr_ is the promoter width. That is in this case, the width of each tag cluster per sample. To have a width more robust to low tag count outliers, _CAGEr_ can determine the width based on a set of quantiles of the cumulative distribution of tag signal per TC. See the figure below.
